...
const end = new Date("Jun 25, 2022 12:00:00").getTime();
...
const int = setInterval(() => {
  ...
  if (remaining < 0) {
    ...
    document.querySelector(".launch-msg").innerHTML =
      "The big day is finally here - view our <a href='https://phantom-codebandits-staging.herokuapp.com'>App here<a/> for more information.";
